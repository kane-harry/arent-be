...
export default class CollectionRouter implements ICustomRouter {
    ...
    private initRoutes() {
        ...
        this.router.get(`${this.path}/rankings`, asyncHandler(CollectionController.getTopCollections))
        ...
        this.router.get(`${this.path}/:key/activity`, asyncHandler(CollectionController.getCollectionActivity))
    }
}
